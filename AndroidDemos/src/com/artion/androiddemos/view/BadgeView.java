...
public class BadgeView extends TextView {
	...
	private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#ff4208"); //Color.RED;FFFF0000
     ...
     */
	public void show() {
		show(R.drawable.message_img_new_normal);
	}
	...
	/**
	 * Make the badge only contains icon visible in the UI
	 */
	public void showOnlyIcon() {
		setText("1");
		setBackgroundResource(R.drawable.common_img_toolbarnew_normal);
		setTextColor(DEFAULT_BADGE_COLOR);
		setTextSize(7);
		setBadgeMargin(dipToPixels(DEFAULT_MARGIN_DIP));
		show(false, null);
	}
